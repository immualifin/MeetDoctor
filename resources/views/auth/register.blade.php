                    ...
                    <div class="mt-12">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="grid gap-6">
                            ...
                            <div class="mt-10 grid gap-6">
                                <button type="submit" class="text-center text-white text-lg font-medium bg-[#2563EB] px-10 py-4 rounded-full">
                                    Continue
                                </button>

                                <a href="{{ route('login') }}" class="text-center text-lg text-[#1E3A5F] font-medium bg-[#EFF6FF] px-10 py-4 rounded-full">
                                    Sign In
                                </a>
                            </div>
                        </form>
